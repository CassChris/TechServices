...
const tableLista = d.querySelector("#tableListaDeseo tbody");
...
function getListaDeseo() {
      ...
      res.productos.forEach((producto) => {
        html += `
                <tr>
                    ...
                    <td>
                        <button class="btn btn-danger btnEliminarDeseo" type="button" prod="${producto.idproducto}"><i class="fas fa-trash"></i></button>
                        <button class="btn btn-primary btnAddCart" type="button" prod="${producto.idproducto}"><i class="fas fa-cart-plus"></i></button>
                    </td>
                </tr>
                `;
      });
  ...
  function btnEliminarDeseo() {
    let listaEliminar = d.querySelectorAll('.btnEliminarDeseo')
...
function btnAgregarProducto() {
  let listaAgregar = d.querySelectorAll('.btnAddCart')
